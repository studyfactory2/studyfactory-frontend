 ...
 */
export type MoreMenuId =
  'beverages' | 'leaves' | 'profile' | 'sideDishes' | 'suggestions';
...
/** One short live fact per row, or null when the row has nothing to say. */
export type MoreMenuValues = Partial<Record<MoreMenuId, string | null>>;
